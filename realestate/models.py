...
class Property(models.Model):
    ...
    sellingprice = models.PositiveIntegerField(verbose_name = _('Property|sellingprice'))
    ...
    surface_area_text = models.PositiveIntegerField(verbose_name = _('Property|surface_area_text'))
    bathrooms_text = models.PositiveIntegerField(verbose_name = _('Property|bathrooms_text'))
    bedrooms_text = models.PositiveIntegerField(verbose_name = _('Property|bedrooms_text'))
